...
import { FriendAvatarGroup } from "@/packages/ui/molecules/friend-avatar-group"
...
export function ConnectionCard({ connection, onClick, isActive = false, className }: ConnectionCardProps) {
        ...
        <div className={styles.info}>
          <div className={styles.topRow}>
            <div className={styles.destination}>
              ...
              <span className={styles.destinationText}>{connection.line.direction}</span>
            </div>
          </div>
          ...
          <div className={styles.timeRow}>
            ...
            <span className={styles.platform}>Platform {connection.departure.platform}</span>
          </div>
